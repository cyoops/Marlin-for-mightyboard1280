...
#define STRING_CONFIG_H_AUTHOR "cyoops" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FFCreator"
...
// cy #define HOTEND_OFFSET_X { 0.0, -34.00 } // (mm) relative X-offset for each nozzle
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  94.139704, 94.139704, 400, 96.2752 }
...
#define BED_CENTER_AT_0_0  //cy 未动，不确定需不需要更改
